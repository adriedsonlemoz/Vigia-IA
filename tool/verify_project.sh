...
grep -Fxq 'version: 1.0.147+147' pubspec.yaml || fail 'Versao esperada 1.0.147+147 nao encontrada.'
...
grep -Fq '## 1.0.147+147' CHANGELOG.md || fail 'CHANGELOG nao documenta 1.0.147.'
[[ -f RELEASE-1.0.147.md ]] || fail 'Notas da entrega 1.0.147 ausentes.'
grep -q "version: '1.0.147'" lib/screens/app_info_screen_components.dart || fail 'Tela Mudancas nao marca a versao 1.0.147.'
grep -q "version: AppBuildVersion(version: '1.0.147', build: 147)" lib/services/update_news_catalog.dart || fail 'Novidades 1.0.147 ausentes do catalogo.'
...
grep -q 'VigiaIA/1.0.147' lib/services/map_cycling_route_service.dart || fail 'User-Agent do roteamento ciclavel nao acompanha a versao atual.'
...
grep -q "static const String version = '1.0.147';" lib/core/app_metadata.dart \
  || fail 'AppMetadata nao esta em 1.0.147.'
grep -q 'static const int build = 147;' lib/core/app_metadata.dart \
  || fail 'Build de AppMetadata nao esta em 147.'
...
grep -Fq 'version: 1.0.147+147' pubspec.yaml \
  || fail 'pubspec.yaml nao esta em 1.0.147+147.'
...
grep -q '"version": "1.0.147"' app_identity.json \
  || fail 'app_identity.json nao esta na versao 1.0.147.'
grep -q '"build": 147' app_identity.json \
  || fail 'app_identity.json nao esta no build 147.'
...
grep -Fq 'Vigia IA 1.0.147+147' ARCHITECTURE.md || fail 'ARCHITECTURE nao esta em 1.0.147+147.'
...
grep -q 'VigiaIA/1.0.147' lib/services/route_explorer_service.dart || fail 'User-Agent do RouteExplorer nao acompanha a versao atual.'
