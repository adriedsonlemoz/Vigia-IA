...
grep -Fxq 'version: 1.0.151+151' pubspec.yaml || fail 'Versao esperada 1.0.151+151 nao encontrada.'
...
grep -Fq '## 1.0.151+151' CHANGELOG.md || fail 'CHANGELOG nao documenta 1.0.151.'
[[ -f RELEASE-1.0.151.md ]] || fail 'Notas da entrega 1.0.151 ausentes.'
grep -q "version: '1.0.151'" lib/screens/app_info_screen_components.dart || fail 'Tela Mudancas nao marca a versao 1.0.151.'
grep -q "version: AppBuildVersion(version: '1.0.151', build: 151)" lib/services/update_news_catalog.dart || fail 'Novidades 1.0.151 ausentes do catalogo.'
...
grep -q 'VigiaIA/1.0.151' lib/services/map_cycling_route_service.dart || fail 'User-Agent do roteamento ciclavel nao acompanha a versao atual.'
...
grep -q "static const String version = '1.0.151';" lib/core/app_metadata.dart \
  || fail 'AppMetadata nao esta em 1.0.151.'
grep -q 'static const int build = 151;' lib/core/app_metadata.dart \
  || fail 'Build de AppMetadata nao esta em 151.'
...
grep -Fq 'version: 1.0.151+151' pubspec.yaml \
  || fail 'pubspec.yaml nao esta em 1.0.151+151.'
...
grep -q '"version": "1.0.151"' app_identity.json \
  || fail 'app_identity.json nao esta na versao 1.0.151.'
grep -q '"build": 151' app_identity.json \
...
grep -Fq 'Vigia IA 1.0.151+151' ARCHITECTURE.md || fail 'ARCHITECTURE nao esta em 1.0.151+151.'
...
grep -q 'VigiaIA/1.0.151' lib/services/route_explorer_service.dart || fail 'User-Agent do RouteExplorer nao acompanha a versao atual.'
