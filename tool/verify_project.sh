...
grep -Fxq 'version: 1.0.109+109' pubspec.yaml || fail 'Versao esperada 1.0.108+108 nao encontrada.'
...
grep -q "static const String version = '1.0.109';" lib/core/app_metadata.dart \
  || fail 'AppMetadata nao esta em 1.0.109.'
grep -q 'static const int build = 109;' lib/core/app_metadata.dart \
  || fail 'Build de AppMetadata nao esta em 109.'
grep -q "version: '1.0.109'" lib/screens/app_info_screen*.dart \
...
grep -Fq 'version: 1.0.109+109' pubspec.yaml \
  || fail 'pubspec.yaml nao esta em 1.0.109+109.'
...
grep -q '"version": "1.0.109"' app_identity.json \
  || fail 'app_identity.json nao esta na versao 1.0.109.'
grep -q '"build": 109' app_identity.json \
  || fail 'app_identity.json nao esta no build 109.'
...
grep -Fq 'Vigia IA 1.0.109+109' ARCHITECTURE.md || fail 'ARCHITECTURE nao esta em 1.0.108+108.'
